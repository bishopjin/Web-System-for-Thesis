...
<body class="" style="	background-image: linear-gradient(to bottom, rgb(28, 181, 224), rgb(0, 0, 70));	background-position: top left;	background-size: 100%; background-repeat: repeat;">
  ...
  <wrapper class="d-flex flex-column min-vh-100">
    ...
    <main class="text-center container-fluid flex-fill text-white py-5 d-flex" style="">
      <div class="container">
        <div class="row" style="">
          <div class="border mx-auto mt-1 p-4 pt-0 col-lg-12 col-12" style="">
             <h2 class="mb-5 text-white">Data Privacy Policy</h2>

             <p class="h6"><a class="text-decoration-none text-white" href="register.php">Click here to continue to registration</a></p>
          </div>
        </div>
      </div>
    </main>
